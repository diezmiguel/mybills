...
class Bills extends \yii\db\ActiveRecord
{
     ...
     * @return Bills[]|array
     */
   public static function getBills(Array $input)
   {
        return self::find()
           ->leftJoin('category c','my_bills.id = c.category')
           ->with('category')
           ->where(array('like','Description',$input['k']))
           ->orWhere(array('like','Organization',$input['k']))
           ->orderBy($input['col'] . " ".$input['dir'])
           ->all();
   }
